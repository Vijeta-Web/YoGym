...
## 🎯 Project Objective
The goal of this project was to build a simple web-based data collection interface that replaces manual form entry with automated and structured cloud storage.
